...
import com.chrisbone.todolist.v1.configs.UserManagerConfig;
import com.chrisbone.todolist.v1.repositories.RefreshTokenRepository;
import com.chrisbone.todolist.v1.security.jwtAuth.JwtAccessTokenFilter;
import com.chrisbone.todolist.v1.security.jwtAuth.JwtRefreshTokenFilter;
import com.chrisbone.todolist.v1.security.jwtAuth.JwtTokenUtils;
import com.chrisbone.todolist.v1.security.jwtAuth.LogoutHandlerService;
...
//    public SecurityFilterChain signInSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
//        return httpSecurity
//                .requestMatchers().antMatchers("/sign-in/**")
//                .and()
//                .csrf().disable()
...
//    public SecurityFilterChain refreshTokenSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
//        return httpSecurity
//                .requestMatchers().antMatchers("/refresh-token/**")
//                .and()
//                .csrf().disable()
//                .authorizeRequests(auth -> auth.anyRequest().authenticated())
//                .oauth2ResourceServer(oauth2 -> oauth2.jwt(jwt -> jwt.jwtAuthenticationConverter(jwtAuthenticationConverter())))
...
//    public SecurityFilterChain logoutSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
//        return httpSecurity
//                .requestMatchers().antMatchers("/logout/**")
//                .and()
//                .csrf().disable()
//                .authorizeRequests(auth -> auth.anyRequest().authenticated())
//                .oauth2ResourceServer(oauth2 -> oauth2.jwt(jwt -> jwt.jwtAuthenticationConverter(jwtAuthenticationConverter())))
...
//    public SecurityFilterChain registerSecurityFilterChain(HttpSecurity httpSecurity) throws Exception {
//        return httpSecurity
//                .requestMatchers().antMatchers("/sign-up/**")
//                .and()
//                .csrf().disable()
